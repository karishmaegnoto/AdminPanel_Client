...
//           <button className="btn btn--primary" onClick={() => { setForm(initialForm); setEditing(null); setShowModal(true) }}>
...
//           <input type="password" placeholder={editing ? 'Password (optional)' : 'Password'} value={form.password} onChange={(e) => setForm({ ...form, password: e.target.value })} required={!editing} />
...
//                 filtered.map((u) => (
//                   <tr key={u._id}>
//                     <td className={styles.nameCell}>{u.firstName} {u.lastName}</td>
//                     <td>{u.email}</td>
//                     <td>{u.department || '—'}</td>
...
//                         <button className={styles.iconBtn} onClick={() => openEdit(u)}><Edit2 size={15} /></button>
//                         <button className={`${styles.iconBtn} ${styles.dangerBtn}`} onClick={() => handleDelete(u._id)}><Trash2 size={15} /></button>
//                         <button className={styles.assignBtn} onClick={() => openAssignModal(u)}>Assign</button>
//                       </div>
//                     </td>
//                   </tr>
//                 ))
...
//         <AssignLeadsToUserModal user={selectedUser} onClose={() => setAssignModal(false)} refresh={load} />
//       )}
//     </div>
//   )
// }
